...
# Case 2. Import from child directory/package first level
# from package_01.module_01 import is_square
# print(is_square())
# from package_01 import module_01 as md1
# print(md1.is_square())

# Case 3. Import from child directory/package second level
...
# Define a function that accepts a number (n) and return n first number of Fibonacci sequences.
def Fibonacci(n):
    # first two terms
    n1, n2 = 0, 1
    count = 0
